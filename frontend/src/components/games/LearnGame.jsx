...
export default function LearnGame({ image, url, title, color }) {
  const openURL = () => {
    Linking.openURL(url);
  };
  ...
  return (
    <View
      style={[styles.imageContainer, { backgroundColor: color || "#f0f0f0" }]}
    >
      <Image source={image} style={styles.learnGameImage} />
