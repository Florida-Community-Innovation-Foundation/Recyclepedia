...
export default function Home() {
  ...
  const [isEventDetailModalVisible, setIsEventDetailModalVisible] =
    useState(false);
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.littleTitle}>
          Empowering Miami's Youth in Climate Action
        </Text>
        ...
        <Modal visible={isModalVisible} transparent={true} animationType="fade">
          ...
          <View style={styles.modalContent}>
            <Text style={styles.modalText}>
              The purpose of Recyclopedia is to educate and empower youth,
              particularly in Miami, about climate action and sustainable
              practices. Through engaging content and interactive lessons,
              Recyclopedia aims to inspire younger generations to understand
              recycling, waste management, and environmental stewardship, making
              climate-friendly practices accessible and interesting for
              students.
            </Text>
      ...
      <View style={styles.communityContainer}>
        <View style={styles.communityLeft}>
          ...
          <Text style={styles.communityParagraph}>
            Get involved with your comumunity and make a difference by exploring
...
<<<<<<< HEAD:frontend/src/app/(protected)/(tabs)/(home)/index.jsx
=======
